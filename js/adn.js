...
const formularioVerificacionADN = document.querySelector("#result");
...
const verificarADN = () => {
    ...
    divSimilitudADN.innerHTML = '<p>Buscando similitud...</p>';
    ...
    ciudadanosSimilares.forEach((ciudadano, index) => {
        ...
        divSimilitudADN.innerHTML += `<p>${index + 1}. Nombre: ${ciudadano.nombre}, Porcentaje de coincidencia: ${porcentaje}%</p>`;
    });
};
